...
import type { AuthControllerLoginData, AuthControllerLoginResponse, PartnerControllerRegisterData, PartnerControllerRegisterResponse, PartnerControllerGetProfileData, PartnerControllerGetProfileResponse, PartnerControllerUpdateData, PartnerControllerUpdateResponse, PartnerControllerOnboardingData, PartnerControllerOnboardingResponse, PartnerControllerAutocompleteData, PartnerControllerAutocompleteResponse } from './types.gen';
 ...
 */
export const partnerControllerOnboarding = <ThrowOnError extends boolean = false>(options: Options<PartnerControllerOnboardingData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PartnerControllerOnboardingResponse, unknown, ThrowOnError>({
 ...
 */
export const partnerControllerAutocomplete = <ThrowOnError extends boolean = false>(options: Options<PartnerControllerAutocompleteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<PartnerControllerAutocompleteResponse, unknown, ThrowOnError>({
